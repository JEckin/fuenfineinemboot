...
public class Var {
	...
	static ImageIcon BootBlau1 = new ImageIcon(Var.class.getClassLoader().getResource("Blau/1.png"));
	static ImageIcon BootBlau2 = new ImageIcon(Var.class.getClassLoader().getResource("Blau/2.png"));
	static ImageIcon BootBlau3 = new ImageIcon(Var.class.getClassLoader().getResource("Blau/3.png"));
	static ImageIcon BootBlau4 = new ImageIcon(Var.class.getClassLoader().getResource("Blau/4.png"));
	static ImageIcon BootRot1 = new ImageIcon(Var.class.getClassLoader().getResource("Rot/1.png"));
	static ImageIcon BootRot2 = new ImageIcon(Var.class.getClassLoader().getResource("Rot/2.png"));
	static ImageIcon BootRot3 = new ImageIcon(Var.class.getClassLoader().getResource("Rot/3.png"));
	static ImageIcon BootRot4 = new ImageIcon(Var.class.getClassLoader().getResource("Rot/4.png"));
	static ImageIcon BootGruen1 = new ImageIcon(Var.class.getClassLoader().getResource("Gruen/1.png"));
	static ImageIcon BootGruen2 = new ImageIcon(Var.class.getClassLoader().getResource("Gruen/2.png"));
	static ImageIcon BootGruen3 = new ImageIcon(Var.class.getClassLoader().getResource("Gruen/3.png"));
	static ImageIcon BootGruen4 = new ImageIcon(Var.class.getClassLoader().getResource("Gruen/4.png"));
	static ImageIcon BootGelb1 = new ImageIcon(Var.class.getClassLoader().getResource("Gelb/1.png"));
	static ImageIcon BootGelb2 = new ImageIcon(Var.class.getClassLoader().getResource("Gelb/2.png"));
	static ImageIcon BootGelb3 = new ImageIcon(Var.class.getClassLoader().getResource("Gelb/3.png"));
	static ImageIcon BootGelb4 = new ImageIcon(Var.class.getClassLoader().getResource("Gelb/4.png"));
